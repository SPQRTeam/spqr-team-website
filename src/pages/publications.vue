<template>
    ...
    <div class="cover-section">
        <v-img
            class="cover-image"
            :style="{ height: '350px' }"            
            src="/spqr-team-website/assets/publications/cover.png"
...
const papers = [

    {
        ...
        cover: '/spqr-team-website/assets/publications/BallDetection.png',
...

    {
        ...
        cover: '/spqr-team-website/assets/publications/LLCoach.png',
        extras: '',
        links: [
            {
...

    {
        ...
        cover: '/spqr-team-website/assets/publications/StructuralPruning.png',
        extras: '',
        links: [
            {
...

    {
        ...
        cover: '/spqr-team-website/assets/publications/PlayEverywhere.png',
...

    {
        ...
        cover: '/spqr-team-website/assets/publications/MARIO.png',
        extras: '',
        links: [
            {
